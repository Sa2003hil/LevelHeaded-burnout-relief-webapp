...
import Img from '../assets/VecOpp.png'
...
export default function Register() {
    ...
    const onSignup = async () => {
        try {
            ...
            // after successful signup, redirect to login page using navigate
            // navigate("/login");
            setTimeout(() => {
                router.push("/signIn");
            }, 2000);
        ...
        <div className="flex gap-10 px-20 w-[100vw] items-center justify-center relative">
            ...
            <div class="relative h-[100vh] mt-10 flex flex-col text-gray-700 bg-white shadow-md w-[30vw] rounded-xl bg-clip-border">
                ...
                <Typography color="blue-gray" className="flex justify-center m-auto text-3xl gap-1 mb-8">
                    Welcome to <span className=" text-pink-400 font-medium">LevelHeaded</span>
                </Typography>
                ...
                <div class="p-6 pt-0">
                    <button
                        onClick={onSignup}
                        class="flex items-center justify-center w-full select-none rounded-lg bg-gradient-to-tr from-gray-900 to-gray-800 py-3 px-6 text-center align-middle font-sans text-xs font-bold uppercase text-white shadow-md shadow-gray-900/10 transition-all hover:shadow-lg hover:shadow-gray-900/20 active:opacity-[0.85] disabled:pointer-events-none disabled:opacity-50 disabled:shadow-none"
                        type="button">
                        {loading ? <TailSpin
                            visible={true}
                            height="20"
