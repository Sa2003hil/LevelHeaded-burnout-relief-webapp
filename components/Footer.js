                ...
                <div className="flex w-full flex-col items-center justify-center py-4 md:flex-row md:justify-between">
                    ...
                    <div className="flex gap-4 text-white sm:justify-center">
                        <Typography
                            as="a"
                            href="#"
                            className="opacity-80 transition-opacity hover:text-blue-600 hover:opacity-100"
                        >
                            <svg
                                className="h-5 w-5"
                                fill="currentColor"
                        ...
                        <Typography
                            as="a"
                            href="#"
                            className="opacity-80 transition-opacity hover:text-pink-500 hover:opacity-100"
                        >
                            <svg
                                className="h-5 w-5"
                                fill="currentColor"
                        ...
                        <Typography
                            as="a"
                            href="#"
                            className="opacity-80 transition-opacity hover:opacity-100 hover:text-blue-400"
                        >
                            <svg
                                className="h-5 w-5"
                                fill="currentColor"
